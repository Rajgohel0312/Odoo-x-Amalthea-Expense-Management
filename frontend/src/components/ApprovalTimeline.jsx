...
export default function AllExpenses() {
  ...
  const [mainOpen, setMainOpen] = useState(true); // main accordion open by default
  const [expanded, setExpanded] = useState(null); // track inner accordions
            ...
            <Stack spacing={1.5}>
              {expenses.map((e) => (
                ...
                >
                  ...
                  {/* Inner Accordion Details */}
                  <AccordionDetails
                    sx={{ bgcolor: "#fafafa", borderTop: "1px solid #eee" }}
                  >
                    <Box sx={{ p: 1 }}>
                      {/* Claimant Info */}
                      <Paper
                      ...
                      >
                        ...
                        <Typography variant="body2">
                          <strong>Amount:</strong> ₹{e.amountInCompanyCurrency}{" "}
                          {e.companyCurrency}
                        </Typography>
                      </Paper>
